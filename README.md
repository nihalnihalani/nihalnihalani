...
- 🎬 **[Veo 3 Studio Voice](https://github.com/nihalnihalani/veo3-studio-voice)** - AI video generation platform with voice integration
- 🛡️ **[ARGUS](https://github.com/nihalnihalani/ARGUS)** - Autonomous real-time guardian for unified cyber threat intelligence
- 🔍 **[RepoLens AI](https://github.com/nihalnihalani/RepoLens-AI-)** - AI-powered GitHub repository analyzer for deep code insights
- 🕸️ **[WebScout](https://github.com/nihalnihalani/WebScout)** - Self-improving browser automation agent that learns from failures
- 🧠 **[EthosLens v2](https://github.com/nihalnihalani/ethoslens-v2)** - Enterprise AI safety and compliance platform with multi-agent moderation
- 🏟️ **[Agent Colosseum](https://github.com/nihalnihalani/agent-colosseum)** - Live arena where AI agents compete with real-time visualization
- 💾 **[Agent Memory](https://github.com/nihalnihalani/agent-memory)** - Universal shared memory MCP server for AI agents
- 📋 **[Clippy AI](https://github.com/nihalnihalani/clippy-ai)** - AI-powered macOS clipboard manager with semantic search and local LLM
- 🔗 **[Multi-Source Knowledge Graph Builder](https://github.com/nihalnihalani/Multi-Source-Knowledge-Graph-Builder)** - Automated pipeline using Airflow and Neo4j with LLM-based entity extraction
- 🚨 **[IncidentIQ](https://github.com/nihalnihalani/IncidentIQ)** - Multi-phase AI operations platform built on Elasticsearch Agent Builder
- 🎯 **[Ad Alchemy](https://github.com/nihalnihalani/ad-alchemy)** - Cultural intelligence meets Veo 3 and Imagen 3 for AI-powered ad generation
- 🤖 **[SelfCoding](https://github.com/nihalnihalani/SelfCoding)** - Self-improving AI code generation with meta-learning and multi-agent systems
- 🏦 **[Intelligence Bazaar](https://github.com/nihalnihalani/intelligence-bazaar)** - Autonomous AI services marketplace with Nevermined payments and CDP wallets
- 💬 **[LiveSports Chat](https://github.com/nihalnihalani/LiveSports-Chat)** - Real-time sports chat platform with live scores built in Go
- 🔒 **[Commit Guard](https://github.com/nihalnihalani/commit-guard)** - AI-powered code compliance and security scanning for Git commits
- 🧬 **[Neo Recall](https://github.com/nihalnihalani/neo-recall)** - Temporal knowledge graph with MongoDB Atlas, Neo4j, and 3D visualization
- 🎙️ **[Better Than Leet](https://github.com/nihalnihalani/better-than-leet)** - AI voice-guided technical interview sandbox with live coding and anti-cheat
- 📡 **[Production Agents](https://github.com/nihalnihalani/Production-Agents-Hackathon)** - Auto-transforms GitHub events into social media content via multi-agent automation
- 🔑 **[LinkedIn Automation](https://github.com/nihalnihalani/LinkedIn-Automation)** - Automated personalized LinkedIn connection requests via Selenium

### Earlier Work

- 📸 **[Clipit](https://github.com/nihalnihalani/Clipit)** - AI-powered clipboard manager for Windows with searchable history
- 🩺 **[RoboDoc](https://github.com/nihalnihalani/RoboDoc)** - Messenger chatbot diagnosing diseases from symptoms and X-rays
- 😷 **[FaceMask Detector](https://github.com/nihalnihalani/FaceMask-detector)** - CNN-based real-time face mask identification
- 🦠 **[COVID-19 X-ray Detection](https://github.com/nihalnihalani/COVID19-Detection-using-X-ray-images-)** - Deep learning model for COVID-19 detection from chest X-rays
- ⛓️ **[BitCoin Networks](https://github.com/nihalnihalani/BitCoin_Networks)** - Blockchain transactional system with full nodes for mining and validation
